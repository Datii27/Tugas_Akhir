    ...
    <div class="col-md-12">
        <div class="card mt-3">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h2 class="card-title">LAPORAN DATA AMONIA</h2>
                <a href="data/report/printAmonia.php" target="_blank" class="btn btn-success">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <?php
                        ...
                        $no = 1;
                        $myx = mysqli_query($coon, "SELECT * FROM amonia ORDER BY id  DESC");
